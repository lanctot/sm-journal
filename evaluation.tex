...
\begin{figure}
\scriptsize
\begin{tabular}{|r|rr|rr|rr|rr|rr|rr|rr|}\hline
&OZ&&OZE&&GS&&RG&&PE&&Tron&&TronE&\\
...
\hline
\end{tabular}
\caption{The number of iterations and  the mean depth of the tree constructed by the sampling algorithms in 5 seconds in the root node of the evaluated games.}
\end{figure}
...
Finally, RM seems to be consistently the best performing algorithm in game playing for this class of games. Out of all the games and both time settings, it loses only in Oshi-Zumo with an evaluation function, where it is outperformed by UCT.
