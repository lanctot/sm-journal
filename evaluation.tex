...
Superior performance of UCT and Exp3 closely second with 5 seconds, but at 1 second RM is the close second. 
%mlanctot: I don't know what you were trying to say here.
%is obvious also in comparison of the sampling algorithms among each other.\vlisy{Why?}
...
% mlanctot: This is too strong/speculative; we only show results in one domain (and it's the one with a lot of pure strategies..) 
%           It partly contradicts what we found in our CIG paper. Parameter tuning will surely be more difficult in this 
%           class of games; just look at the effect of randomization. And there is not much value in stating this. 
