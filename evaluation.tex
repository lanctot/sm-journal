...
\mlanctot{@Viliam: please check that I have understood your email correctly.. it was missing some information, so I had to
make some assumptions.}

Given the similar nature of these OOS and RM, one might wonder why RM performs consistently better in online search
than OOS, despite OOS being the only algorithm with provable convergence properties. In this subsection, we present results of 
...
where $\cI_i$ and $\tilde{\Delta}_i$ are constants determined by the game structure, and 
$\bVar$ and $\bCov$ are the maximal variance and covariance of the term $r^t(s,a) - \tilde{r}^t(s,a)$ over all information sets of
...
so we can get a good estimate by instead computing
...
\hline
OZ(3,50,1) &	$1$ &	$34900$	& $1010.73$ & $25654$	& $9.19$ \\
OZ(3,50,1) &	$2$	& $40876$	& $1225.89$ & $26719$	& $7.93$ \\
OZ(3,50,1) &	$3$	& $40306$	& $1016.42$ & $26121$	& $7.99$ \\
\hline
...
to avoid the uncertainty introduced by the variance.
