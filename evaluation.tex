...
First, we analyze the games with fixed ordering of the cards by nature. 
The results are depicted in Figure~\ref{fig:off:res:gs} (note the logarithmic y-scale).
The comparison shows that a significant number of subgames has a pure subgame Nash equilibrium that can be computed using serialized alpha-beta algorithms.
