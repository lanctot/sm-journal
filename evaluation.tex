mu\subsection{Experimental Settings}
...
While EXP3 eventually converges close to $0$, UCT is not able to reach error lower than $0.5$ (the minimum error was $0.37$ out of all runs and all samples).\vlisy{update}
...
In Goofspiel $5$, $\biab$ is slightly faster and finishes first in less than $1$ second, following by $\doab$ ($1.52$ seconds), \textsc{DO} ($4.25$ seconds), and \textsc{BI} ($7.11$).\vlisy{legend for BI algorithms still missing}
...
On the other hand, while OOS is able to keep the convergence rate and reach almost $0$ exploitability, UCT again converges to exploitable strategy with error $0.73$ at best.\vlisy{update} 
...
\end{tabular}
%\begin{tabular}{|r|rrrrrr|}\hline
%RG(5,15)&DOAB&OOS&UCT&EXP3&RM&RAND\\\hline
%DOAB&&53.3(2.7)&53.8(2.7)&56.7(2.7)&51.5(2.7)&68.2(2.6)\\
%OOS&48.0(2.7)&&49.6(2.7)&47.9(2.7)&48.4(2.7)&65.7(2.6)\\
%UCT&49.2(2.7)&51.2(2.7)&&52.0(2.8)&47.3(2.7)&66.1(2.6)\\
%EXP3&48.1(2.7)&57.3(2.7)&54.5(2.7)&&49.1(2.7)&69.5(2.5)\\
%RM&51.9(2.7)&55.0(2.7)&56.1(2.6)&54.7(2.7)&&69.0(2.6)\\
%RAND&34.0(2.6)&39.8(2.7)&40.0(2.7)&34.4(2.6)&33.6(2.6)&\\
%\hline
%\end{tabular}
\begin{tabular}{|r|rrrrrr|}\hline
...
\end{scriptsize}
%All tables with 1000 runs, few DOAB runs still with bugs. TronE, OZE with evaluation function. PE from 10 different starts, RG 10 different games. Parameters always OOS:0.6,UCT:2,EXP3:0.2,RM:0.1.
