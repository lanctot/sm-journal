...
\bbosansky{Add tables with measured data about how much we need to mix for each game.}
...
\bbosansky{Marc, could you please describe the evaluation function for Tron here with a reference, if the evaluation function you have used is described somewhere.}
\mlanctot{Yup, will do.}
