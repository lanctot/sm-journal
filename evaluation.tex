...
\bbosansky{TODO: replot convergence graphs $\rightarrow$ UCT is used instead of RUCT, legend is not displayed properly}
...
While Exp3 eventually converges close to $0$ in the win-tie-loose case, the exploitability of UCT decreases rather slowly and it was still over $0.35$ at the time limit of $300$ seconds. \bbosansky{TODO UPDATE!}
