...
\bbosansky{Mark, could you please describe the evaluation function for Tron here with a reference, if the evaluation function you have used is described somewhere.}
...
In Goofspiel $5$, $\biab$ is slightly faster and finishes first in less than $1$ second, following by $\doab$ ($1.52$ seconds), \textsc{DO} ($4.25$ seconds), and \textsc{BI} ($7.11$).\vlisy{legend for BI algorithms still missing}\bbosansky{I am working on that.}
...
\subsubsection{Tron}
From the perspective of offline computation of strategies, Tron is less interesting compared to the previous games.
\bbosansky{TODO: Finish This!}
