...
Alternatively, we can treat chance in a standard way, where chance nodes determine the card that gets drawn. We refer to this settings as with the
...
The formal definition follows ($c_i$ are the sum of values the remaining cards of player $i$):
