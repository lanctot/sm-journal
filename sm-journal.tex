...
These situations occur in many real-world scenarios like auctions~(e.g.,~\cite{Keuter1997}), or autonomous driving, and many of video and board games in the expanding gaming industry are of this nature~(e.g.,~\cite{Beard12Using} and games we use for our experiments).
