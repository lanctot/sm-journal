...
\vlisy{Arguments for relevance of the class of games and examples of games we solve are missing. I would also mention the need for mixing in this game, which makes them fundamentally different form sequential games.}
...
T  & 0  &  1\\\cline{2-3}
\end{tabular}
\caption{Matrix game of Matching Pennies.\label{fig:matchinPennies}}
\end{figure}
...
\mlanctot{Planning to fill this over the weekend. Why is SM-MCTS in the offline part?}
