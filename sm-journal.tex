...
In this paper, we survey the literature on algorithms that compute strategies
...
When used in online search with a good evaluation function, this method performs well in games with high support and accurate
assessment from limited look-ahead is required.
For the Monte Carlo sampling algortihms, UCT can often find a good pure strategy quickly if one exixts, but in other games its
