...
\author[1]{Branislav Bosansky\footnote{Corresponding author; phone: +420 22435 7581}}
\author[1]{Viliam Lisy}
\author[2]{Marc Lanctot\footnote{\bbosansky{@Marc, please double-check your address in Maastricht and maybe write an alternate address for yourself} present address}}
\author[1]{Jiri Cermak}
...
$\langle\textrm{first\_name}\rangle.\langle\textrm{last\_name}\rangle$@agents.fel.cvut.cz}

\address[2]{Department of Knowledge Engineering, Maastricht University, \\P.O. Box 616, 6200 MD, Maastricht, The Netherlands\\
$\langle\textrm{first\_name}\rangle.\langle\textrm{last\_name}\rangle$@maastrichtuniversity.nl}
...
Second, we present detailed descriptions of several recent exact and approximative algorithms to compute strategies for this class of games. 
