...
\reviewchange{
For exact algorithms, the results show that our pruning techniques for backward induction dramatically improve the computation time required by previous exact algorithms.
For sampling algorithms, the results provide unique insights by identifying favorable scenarios for different sampling algorithms.
}
...
\reviewchange{
On the other hand, it is not a good representation of the environment when agents are allowed to act simultaneously.
These situations occur in many real-world scenarios like auctions, or autonomous driving, and many of computer and board games in the expanding gaming industry are of this nature.
In all of these scenarios, the simultaneousness of the decision of all players is crucial and we have to include it directly into the model when computing strategies to play in these games.}

One of the fundamental differences of simultaneous move games compared to strictly sequential
