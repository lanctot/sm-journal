...
\author[1]{Branislav Bo{\v s}ansk{\' y}\footnote{Corresponding author; phone: +420 22435 7581}}
...
for two-player zero-sum simultaneous move games and describe our most recent exact and approximative algorithms.
We evaluate the algorithms in two specific cases: the offline case, where computational 
...
domains previously used in the literature and in randomly generated games. 
\end{abstract}
