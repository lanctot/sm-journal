...
No rational player would want to play a strictly dominated action, because there is always a better one to play instead, for any action used by the opponent. The concept also extends naturally to behavioral strategies.
For example, in the game on the right of Figure~\ref{fig:egMatrixGames}, both $b$ and $B$ are strictly dominated.
In this paper we refer to the dominance always in this strict meaning.
