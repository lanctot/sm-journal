...
here is simpler for implementation and it further reduces the variance of the regret estimates, which leads to a faster convergence and a better game play.
...
First, the whole game tree is eventually built by the algorithm.
 A direct consequence of \cite[Lemma 43]{Kovarik2015Analysis} is that the tree of depth $D$ is built with probability $(1-p_1)$ in less than
 \begin{equation}
