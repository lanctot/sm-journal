...
The main idea of the proof is to define a specific class of games (see Example~2 in \cite{Kovarik2015Analysis}), in which the exploration in a greater depth of the game tree causes a bias in the values observed in the higher levels of the tree, consequently leading to a wrong decision in the root.
