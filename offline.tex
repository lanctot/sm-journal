...
solves the matrix game $A$ by using the standard linear program (LP) for solving normal-form games\footnote{\reviewchange{By solving a game we mean computing both the optimal value and the strategy that achieves it.}}:
\begin{eqnarray}
\max & v_s & \\
...
\reviewchange{We call this purely alternating form a {\it serialization} of the original game.}
